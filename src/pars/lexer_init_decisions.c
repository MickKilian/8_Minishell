...
int	ft_init_lex_decision_1(t_lex *lex)
{
	...
	lex->decision[NEW_LEX_RD_MD][DOL_CHAR] = (t_lex_proc){LEX_KEEP, LEX_TAKE, STD_LEX_RD_MD, TOK_WORD};
...
int	ft_init_lex_decision_3(t_lex *lex)
{
	...
	lex->decision[ESCP_LEX_RD_MD][PIPE_CHAR] = (t_lex_proc){LEX_DROP, LEX_SKIP, ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[ESCP_LEX_RD_MD][AMP_CHAR] = (t_lex_proc){LEX_DROP, LEX_SKIP, ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[ESCP_LEX_RD_MD][LT_CHAR] = (t_lex_proc){LEX_DROP, LEX_TAKE, ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[ESCP_LEX_RD_MD][GT_CHAR] = (t_lex_proc){LEX_DROP, LEX_TAKE, ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[ESCP_LEX_RD_MD][DOL_CHAR] = (t_lex_proc){LEX_KEEP, LEX_TAKE, STD_LEX_RD_MD, TOK_WORD};
...
//check following case
	...
	lex->decision[PIPE_LEX_RD_MD][LT_CHAR] = (t_lex_proc){LEX_KEEP, LEX_TAKE, ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[PIPE_LEX_RD_MD][GT_CHAR] = (t_lex_proc){LEX_KEEP, LEX_TAKE, ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[PIPE_LEX_RD_MD][DOL_CHAR] = (t_lex_proc){LEX_CATCH, LEX_TAKE, STD_LEX_RD_MD, TOK_WORD};
	lex->decision[PIPE_LEX_RD_MD][END_CHAR] = (t_lex_proc){LEX_DROP, LEX_SKIP, ERR_LEX_RD_MD, TOK_NEW};
	return (0);
}
...
int	ft_init_lex_decision_4(t_lex *lex)
{
	...
	lex->decision[AMP_LEX_RD_MD][SPL_CHAR] = (t_lex_proc){LEX_CATCH, LEX_SKIP, ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[AMP_LEX_RD_MD][DBL_CHAR] = (t_lex_proc){LEX_DROP, LEX_SKIP, ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[AMP_LEX_RD_MD][ESCP_CHAR] = (t_lex_proc){LEX_CATCH, LEX_SKIP, ESCP_LEX_RD_MD, TOK_NEW};
	lex->decision[AMP_LEX_RD_MD][PIPE_CHAR] = (t_lex_proc){LEX_DROP, LEX_SKIP, ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[AMP_LEX_RD_MD][AMP_CHAR] = (t_lex_proc){LEX_KEEP, LEX_TAKE, AND_LEX_RD_MD, TOK_OP_AND};
	lex->decision[AMP_LEX_RD_MD][LT_CHAR] = (t_lex_proc){LEX_DROP, LEX_SKIP, ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[AMP_LEX_RD_MD][GT_CHAR] = (t_lex_proc){LEX_DROP, LEX_SKIP, ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[AMP_LEX_RD_MD][DOL_CHAR] = (t_lex_proc){LEX_CATCH, LEX_TAKE, STD_LEX_RD_MD, TOK_WORD};
	lex->decision[AMP_LEX_RD_MD][END_CHAR] = (t_lex_proc){LEX_DROP, LEX_SKIP, ERR_LEX_RD_MD, TOK_NEW};
...
int	ft_init_lex_decision_5(t_lex *lex)
{
	...
	lex->decision[GT_LEX_RD_MD][PIPE_CHAR] = (t_lex_proc){LEX_CATCH, LEX_SKIP, ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[GT_LEX_RD_MD][AMP_CHAR] = (t_lex_proc){LEX_CATCH, LEX_SKIP, ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[GT_LEX_RD_MD][LT_CHAR] = (t_lex_proc){LEX_CATCH, LEX_SKIP, ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[GT_LEX_RD_MD][GT_CHAR] = (t_lex_proc){LEX_KEEP, LEX_TAKE, GGRT_LEX_RD_MD, TOK_GGRT};
	lex->decision[GT_LEX_RD_MD][DOL_CHAR] = (t_lex_proc){LEX_CATCH, LEX_TAKE, STD_LEX_RD_MD, TOK_WORD};
	...
	lex->decision[OR_LEX_RD_MD][SPL_CHAR] = (t_lex_proc){LEX_CATCH, LEX_SKIP, ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[OR_LEX_RD_MD][DBL_CHAR] = (t_lex_proc){LEX_DROP, LEX_SKIP, ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[OR_LEX_RD_MD][ESCP_CHAR] = (t_lex_proc){LEX_CATCH, LEX_SKIP, ESCP_LEX_RD_MD, TOK_NEW};
	lex->decision[OR_LEX_RD_MD][PIPE_CHAR] = (t_lex_proc){LEX_DROP, LEX_SKIP, ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[OR_LEX_RD_MD][AMP_CHAR] = (t_lex_proc){LEX_CATCH, LEX_TAKE, AND_LEX_RD_MD, TOK_OP_AND};
	lex->decision[OR_LEX_RD_MD][LT_CHAR] = (t_lex_proc){LEX_DROP, LEX_SKIP, ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[OR_LEX_RD_MD][GT_CHAR] = (t_lex_proc){LEX_DROP, LEX_SKIP, ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[OR_LEX_RD_MD][DOL_CHAR] = (t_lex_proc){LEX_CATCH, LEX_TAKE, STD_LEX_RD_MD, TOK_WORD};
...
int	ft_init_lex_decision_7(t_lex *lex)
{
	...
	lex->decision[GGRT_LEX_RD_MD][PIPE_CHAR] = (t_lex_proc){LEX_CATCH, LEX_SKIP, ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[GGRT_LEX_RD_MD][AMP_CHAR] = (t_lex_proc){LEX_CATCH, LEX_SKIP, ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[GGRT_LEX_RD_MD][LT_CHAR] = (t_lex_proc){LEX_CATCH, LEX_SKIP, ERR_LEX_RD_MD, TOK_NEW};
	lex->decision[GGRT_LEX_RD_MD][GT_CHAR] = (t_lex_proc){LEX_CATCH, LEX_SKIP, SPL_LEX_RD_MD, TOK_GGRT};
	lex->decision[GGRT_LEX_RD_MD][DOL_CHAR] = (t_lex_proc){LEX_CATCH, LEX_TAKE, STD_LEX_RD_MD, TOK_WORD};

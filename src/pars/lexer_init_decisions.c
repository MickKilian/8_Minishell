...
/*   Updated: 2022/10/05 21:51:49 by mbourgeo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_init_lex_decision_2(t_lex *lex)
{
	...
	lex->decision[SPL_LEX_RD_MD][END_CHAR] = (t_lex_proc){LEX_SYNT_ERR, LEX_DROP, SYNT_ERR_LEX_RD_MD, TOK_ERR_SPL};
	...
	lex->decision[DBL_LEX_RD_MD][END_CHAR] = (t_lex_proc){LEX_SYNT_ERR, LEX_SKIP, SYNT_ERR_LEX_RD_MD, TOK_ERR_DBL};
	return (0);
}

...
int	ft_init_exp_decision_1(t_pars *pars)
{
	...
	pars->exp_decision[NEW_EXP_RD_MD][END_CHAR] = (t_exp_proc){EXP_ERR, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_WORD};
...
int	ft_init_exp_decision_2(t_pars *pars)
{
	...
	pars->exp_decision[SPL_EXP_RD_MD][END_CHAR] = (t_exp_proc){EXP_ERR, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_ERR_SPL};
	...
	pars->exp_decision[DBL_EXP_RD_MD][END_CHAR] = (t_exp_proc){EXP_ERR_DBL, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_ERR_DBL};
	//pars->exp_decision[NEW_EXP_RD_MD][TOK_NEW] = (t_exp_proc){EXP_KEEP, EXP_SKIP, NEW_EXP_RD_MD};
...
/*	pars->exp_decision[ESCP_EXP_RD_MD][SEP_CHAR] = (t_exp_proc){EXP_KEEP, EXP_SKIP, NEW_EXP_RD_MD, TOK_NEW};
	...
	pars->exp_decision[ESCP_EXP_RD_MD][PIPE_CHAR] = (t_exp_proc){EXP_DROP, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[ESCP_EXP_RD_MD][AMP_CHAR] = (t_exp_proc){EXP_DROP, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[ESCP_EXP_RD_MD][LT_CHAR] = (t_exp_proc){EXP_DROP, EXP_TAKE, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[ESCP_EXP_RD_MD][GT_CHAR] = (t_exp_proc){EXP_DROP, EXP_TAKE, SYNT_ERR_EXP_RD_MD, TOK_NEW};
...
//check following case
	...
	pars->exp_decision[PIPE_EXP_RD_MD][LT_CHAR] = (t_exp_proc){EXP_KEEP, EXP_TAKE, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[PIPE_EXP_RD_MD][GT_CHAR] = (t_exp_proc){EXP_KEEP, EXP_TAKE, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[PIPE_EXP_RD_MD][END_CHAR] = (t_exp_proc){EXP_DROP, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	*/
	return (0);
}
...
/*	pars->exp_decision[AMP_EXP_RD_MD][SEP_CHAR] = (t_exp_proc){EXP_CATCH, EXP_SKIP, NEW_EXP_RD_MD, TOK_NEW};
	...
	pars->exp_decision[AMP_EXP_RD_MD][SPL_CHAR] = (t_exp_proc){EXP_CATCH, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[AMP_EXP_RD_MD][DBL_CHAR] = (t_exp_proc){EXP_DROP, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[AMP_EXP_RD_MD][ESCP_CHAR] = (t_exp_proc){EXP_CATCH, EXP_SKIP, ESCP_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[AMP_EXP_RD_MD][PIPE_CHAR] = (t_exp_proc){EXP_DROP, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[AMP_EXP_RD_MD][AMP_CHAR] = (t_exp_proc){EXP_KEEP, EXP_TAKE, AND_EXP_RD_MD, TOK_OP_AND};
	pars->exp_decision[AMP_EXP_RD_MD][LT_CHAR] = (t_exp_proc){EXP_DROP, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[AMP_EXP_RD_MD][GT_CHAR] = (t_exp_proc){EXP_DROP, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[AMP_EXP_RD_MD][END_CHAR] = (t_exp_proc){EXP_DROP, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	...
	pars->exp_decision[LT_EXP_RD_MD][PIPE_CHAR] = (t_exp_proc){EXP_DROP, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[LT_EXP_RD_MD][AMP_CHAR] = (t_exp_proc){EXP_DROP, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[LT_EXP_RD_MD][LT_CHAR] = (t_exp_proc){EXP_KEEP, EXP_TAKE, HEREDOC_EXP_RD_MD, TOK_HEREDOC};
	pars->exp_decision[LT_EXP_RD_MD][GT_CHAR] = (t_exp_proc){EXP_DROP, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_WORD};
...
/*	pars->exp_decision[GT_EXP_RD_MD][SEP_CHAR] = (t_exp_proc){EXP_CATCH, EXP_SKIP, NEW_EXP_RD_MD, TOK_NEW};
	...
	pars->exp_decision[GT_EXP_RD_MD][PIPE_CHAR] = (t_exp_proc){EXP_CATCH, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[GT_EXP_RD_MD][AMP_CHAR] = (t_exp_proc){EXP_CATCH, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[GT_EXP_RD_MD][LT_CHAR] = (t_exp_proc){EXP_CATCH, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	...
	pars->exp_decision[OR_EXP_RD_MD][SPL_CHAR] = (t_exp_proc){EXP_CATCH, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[OR_EXP_RD_MD][DBL_CHAR] = (t_exp_proc){EXP_DROP, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[OR_EXP_RD_MD][ESCP_CHAR] = (t_exp_proc){EXP_CATCH, EXP_SKIP, ESCP_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[OR_EXP_RD_MD][PIPE_CHAR] = (t_exp_proc){EXP_DROP, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[OR_EXP_RD_MD][AMP_CHAR] = (t_exp_proc){EXP_CATCH, EXP_TAKE, AND_EXP_RD_MD, TOK_OP_AND};
	pars->exp_decision[OR_EXP_RD_MD][LT_CHAR] = (t_exp_proc){EXP_DROP, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[OR_EXP_RD_MD][GT_CHAR] = (t_exp_proc){EXP_DROP, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
...
/*	pars->exp_decision[AND_EXP_RD_MD][SEP_CHAR] = (t_exp_proc){EXP_CATCH, EXP_SKIP, NEW_EXP_RD_MD, TOK_NEW};
	...
	pars->exp_decision[AND_EXP_RD_MD][PIPE_CHAR] = (t_exp_proc){EXP_DROP, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[AND_EXP_RD_MD][AMP_CHAR] = (t_exp_proc){EXP_DROP, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[AND_EXP_RD_MD][LT_CHAR] = (t_exp_proc){EXP_KEEP, EXP_TAKE, HEREDOC_EXP_RD_MD, TOK_HEREDOC};
	pars->exp_decision[AND_EXP_RD_MD][GT_CHAR] = (t_exp_proc){EXP_DROP, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_WORD};
	pars->exp_decision[AND_EXP_RD_MD][END_CHAR] = (t_exp_proc){EXP_DROP, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	...
	pars->exp_decision[HEREDOC_EXP_RD_MD][PIPE_CHAR] = (t_exp_proc){EXP_DROP, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[HEREDOC_EXP_RD_MD][AMP_CHAR] = (t_exp_proc){EXP_DROP, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[HEREDOC_EXP_RD_MD][LT_CHAR] = (t_exp_proc){EXP_DROP, EXP_TAKE, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[HEREDOC_EXP_RD_MD][GT_CHAR] = (t_exp_proc){EXP_DROP, EXP_TAKE, SYNT_ERR_EXP_RD_MD, TOK_NEW};
...
/*	pars->exp_decision[GGRT_EXP_RD_MD][SEP_CHAR] = (t_exp_proc){EXP_CATCH, EXP_SKIP, NEW_EXP_RD_MD, TOK_NEW};
	...
	pars->exp_decision[GGRT_EXP_RD_MD][PIPE_CHAR] = (t_exp_proc){EXP_CATCH, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[GGRT_EXP_RD_MD][AMP_CHAR] = (t_exp_proc){EXP_CATCH, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
	pars->exp_decision[GGRT_EXP_RD_MD][LT_CHAR] = (t_exp_proc){EXP_CATCH, EXP_SKIP, SYNT_ERR_EXP_RD_MD, TOK_NEW};
